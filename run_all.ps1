...
foreach ($seed in $seeds) {
    # +Tutee (no ES)
    Run-Train -tag 'tutee_no_es' -seed $seed -arch 'hrl' -llMode 'multi' -useTutee
#
#    # +Tutee + ES (CFA/wCKA)
#    Run-Train -tag 'tutee_weighted_cka' -seed $seed -arch 'hrl' -llMode 'multi' -useTutee -experienceSharing -shareMode 'weighted_cka'
#
